...
const nanoid_1 = require("nanoid"); //version vieja de nanoid porque la nueva dio problemas
// import { v4 as uuidv4 } from "uuid"; usamos nanoid es mas rapido....
...
app.post("/rooms", (req, res) => {
    ...
    usersCollection
        ...
        .then((doc) => {
        if (doc.exists) {
            const romRef = db_1.rtdb.ref("rooms/" + (0, nanoid_1.nanoid)());
